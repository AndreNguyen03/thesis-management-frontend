...
const FieldsContainer = ({ selectedFields, isEditing = false, onSelectionChange }: FieldsContainerProps) => {
	...
	// Fetch data
	const { data: fieldPagingData, isLoading, isFetching } = useGetFieldsQuery(queriesField)
