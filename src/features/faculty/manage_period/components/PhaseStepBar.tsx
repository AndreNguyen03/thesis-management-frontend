                        ...
                        <div key={phase.phase} className="flex flex-col items-center">
                            ...
                            <Tooltip>
                                <TooltipTrigger asChild>
                                    <motion.button
                                        ...
                                        className={cn(
                                            ...
                                            isCompleted && 'from-success to-success/80 border-success bg-gradient-to-br',
                                            isActive && 'border-primary bg-gradient-to-br from-primary to-primary/80 shadow-lg shadow-primary/30',
                                    ...
                                    >
                                        {isCompleted ? (
                                            ...
                                            <Circle className={cn('h-7 w-7', isActive ? 'text-white' : 'text-muted-foreground')} />
                                        )}
                                ...
                                <TooltipContent side="right">
                                    ...
                                    <p className="text-sm text-muted-foreground">{phase.phase.replace('_', ' ')}</p>
                                </TooltipContent>
                            </Tooltip>

                            {!isLast && (
                                <motion.div
                                    className={cn('my-4 w-1 origin-top rounded', isCompleted ? 'bg-success/80' : 'bg-step-inactive')}
                                    initial={{ scaleY: 0 }}
