...
import type {
	...
	SortOrder,
	TableAction
} from '@/features/faculty/manage_period/components/types'
import type { PaginationTopicsQueryParams } from '@/models/topic.model'
import { DropdownMenu, DropdownMenuContent, DropdownMenuItem, DropdownMenuTrigger } from '@/components/ui/dropdown-menu'
import { LoadingState } from '@/components/ui/LoadingState'
import { EmptyState } from '@/components/ui/EmptyState'

export function TopicsDataTable<T extends Record<string, any>>({
	data,
	columns,
	actions,
	isLoading,
	...
	const debouncedUpdateQuery = useDebounceGeneric<PaginationTopicsQueryParams>(onQueryChange, 500)
	...
	const updateQuery = (updates: Partial<PaginationTopicsQueryParams>) => {
		const params = {
            ...queryParams,
			page,
			limit: pageSize,
