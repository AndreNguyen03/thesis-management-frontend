				...
				<ScrollArea className='max-h-[600px] pr-4'>
					<div className='space-y-6 py-4'>
						...
						<div className='space-y-2'>
							...
							<p className='pl-6 text-sm text-foreground'>{topic.instructor}</p>
						</div>
						...
						{topic.student && (
							<div className='space-y-2'>
								...
								<p className='pl-6 text-sm text-foreground'>{topic.student}</p>
							</div>
						)}
						...
						{typeof topic.score !== 'undefined' && (
							<div className='space-y-2'>
								...
								<p className='pl-6 text-lg text-sm font-semibold text-foreground'>{topic.score}/10</p>
							</div>
						)}
						...
						{typeof topic.registrationCount !== 'undefined' && (
							<div className='space-y-2'>
								...
								<p className='pl-6 text-sm text-foreground'>{topic.registrationCount} sinh viên</p>
							</div>
						)}
						...
						<div className='space-y-2'>
							...
							<p className='pl-6 text-sm text-foreground'>
						...
						<div className='space-y-2'>
							...
							<p className='pl-6 text-sm leading-relaxed text-muted-foreground'>
								Đây là mô tả chi tiết về đề tài. Nội dung này sẽ được cập nhật từ dữ liệu thực tế. Bao
								gồm mục tiêu, phạm vi, công nghệ sử dụng và kết quả mong đợi của đề tài.
							</p>
						</div>
					</div>
				</ScrollArea>
