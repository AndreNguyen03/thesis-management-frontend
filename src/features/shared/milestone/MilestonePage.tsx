...
import {
	...
	type RequestTopicInMilestoneBatchQuery
...
import CreateMilestoneForm from './modal/CreateMilestoneForm'
...
const MilestonePage = () => {
	...
	} = useGetMilestonesCreatedByFacultyBoardQuery(id!, {
	...
	return (
		<div className='flex max-h-[90vh] max-w-7xl flex-col bg-white'>
			{!isMilestoneScreen ? (
											...
											<tr key={index} className='border-b last:border-b-0 hover:bg-gray-50'>
												<td className='max-w-[100px] px-3 py-2'>
													<span className='font-semibold text-gray-900'>
														{(queriesTopics.page! - 1) * queriesTopics.limit! + index + 1}
													</span>
												</td>
												...
												<td className='px-3 py-2'>
													<span className='font-semibold text-red-500'>{t.majorName}</span>
												</td>
												<td className='px-3 py-2'>
													<span className='font-semibold text-gray-700'>{t.studentNum}</span>
												</td>
												<td className='px-3 py-2'>
				...
				<>
					...
					<div className='h-[600px] space-y-6 overflow-y-auto pr-1'>
						<CreateMilestoneForm periodId={id!} />
