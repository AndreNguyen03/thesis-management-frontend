...
const CreateDefenseMilestoneForm = ({
	periodId,
	open,
	setIsOpen
}: {
	...
	const [createMilestone, { isLoading: isCreating, isError: isErrorCreating }] = useFacultyCreateMilestoneMutation()
		...
		<Dialog open={open} onOpenChange={setIsOpen}>
			<DialogContent className='flex max-h-[90vh] max-w-7xl flex-col bg-white'>
				<div className='rounded-lg border border-blue-200 bg-blue-50 p-4'>
					<h3 className='mb-3 flex w-fit cursor-pointer items-center gap-2 font-semibold text-blue-900 hover:bg-slate-200'>
...
export default CreateDefenseMilestoneForm
