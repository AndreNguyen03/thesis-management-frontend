...
const mockMessages: Message[] = [
  { id: 1, text: 'Chào các bạn! Hôm nay chúng ta họp nhóm nhé?', sender: 'other', senderName: 'Nguyễn Văn A', time: '09:00' },
  { id: 2, text: 'Ok bạn, mình sẵn sàng rồi!', sender: 'user', senderName: 'Bạn', time: '09:02' },
  { id: 3, text: 'Mình đã hoàn thành phần wireframe, các bạn review giúp nhé', sender: 'other', senderName: 'Trần Thị B', time: '09:05' },
  { id: 4, text: 'Tuyệt vời! Để mình xem ngay', sender: 'user', senderName: 'Bạn', time: '09:07' },
  { id: 5, text: 'Phần database cũng đã xong, test case đã pass hết', sender: 'other', senderName: 'Lê Văn C', time: '09:10' },
  { id: 6, text: 'Great progress! Họp lúc 10h sáng mai để review tổng thể nhé', sender: 'user', senderName: 'Bạn', time: '09:15' },
];
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex-1 relative">
            <input
              ...
              className="w-full px-4 py-2.5 rounded-xl bg-secondary border-0 text-foreground placeholder:text-muted-foreground focus:ring-2 focus:ring-primary/50 focus:outline-none"
            />
          </div>
          <button className="p-2 rounded-lg hover:bg-secondary transition-colors">
